...
<body>
  ...
  <div class='calendar' id='calendar'><span class="c_count">尊敬的<span class="red"><%=request.getAttribute("loginUser") %></span>,您好 您当月已订<span style="color:red;font-size:35px;"><%=request.getAttribute("orderCount") %></span>次,合计<span style="color:red;font-size:35px;"><%=request.getAttribute("orderCountMoney") %></span>元 已订日期请看下面日期列表 <a href="list">当月统计</a>>>><a href="index?method=logout">注销</a>>>><a href="zf.html" target="_blank" >缴费</a>>>><a href="index?method=trans" target="_blank" >转让(仅限当天)</a></span></div>
